...
* **Did the problem start happening recently** (e.g. after updating to a new version of code-writer) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of code-writer ?** What's the most recent version in which the problem doesn't happen? You can download older versions of code-writer from [the releases page](https://github.com/digipolitan/code-writer/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of code-writer are you using?
...
#### Template For Submitting Bug Reports
    ...
    **code-writer version:** [Enter code-writer version here]
    ...
    * Problem started happening recently, didn't happen in an older version of code-writer: [Yes/No]
